...
public class MatTest {
	...
	public void testMatDoubleArrayArray() {
		...
		for(int i=0;i!=_row1.length;i++) input[0][i]=_row1[i];
		for(int i=0;i!=_row2.length;i++) input[1][i]=_row2[i];
		for(int i=0;i!=_row3.length;i++) input[2][i]=_row3[i];
		for(int i=0;i!=_row4.length;i++) input[3][i]=_row4[i];
		Mat expected = new Mat (input);
		for (int i=0;i<_row1.length;i++) assertEquals((Double)_row1[i],(Double)expected.at(0,i));
		for (int i=0;i<_row1.length;i++) assertEquals((Double)_row2[i],(Double)expected.at(1,i));
		for (int i=0;i<_row1.length;i++) assertEquals((Double)_row3[i],(Double)expected.at(2,i));
		for (int i=0;i<_row1.length;i++) assertEquals((Double)_row4[i],(Double)expected.at(3,i));
	 ...
	 */
	@Test
	public void testInsert_colsIntInt() {
		//fail("Not yet implemented");
	}
	 ...
	 */
	@Test
	public void testInsert_rowsIntMat() {
		//fail("Not yet implemented");
	}
