...
public class TestGenRowVecRowIndColInd extends TestClass {

  @Parameters(name = "{index}: GenRowVec = {0}, RowInd = {2}, ColInd = {4}")
  ...
  @Before
  public void before() {
    _fileSuffix = _genRowVecString + "," + _rowIndString + "," + _colIndString;
