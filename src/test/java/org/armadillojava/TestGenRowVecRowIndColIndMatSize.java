...
public class TestGenRowVecRowIndColIndMatSize extends TestClass {

  @Parameters(name = "{index}: GenRowVec = {0}, RowInd = {2}, ColInd = {4}, MatSize = {6}")
  ...
  @Before
  public void before() {
    _fileSuffix = _genRowVecString + "," + _rowIndString + "," + _colIndString + "," + _matSizeString;
  ...
  public void testRowIn_range() throws IOException {
    ...
    if (_genRowVec.in_range(_rowInd, _colInd, _matSize)) {
      ...
      System.out.println(_rowInd + _matSize.n_rows - 1 < _genRowVec.n_rows);
      System.out.println(_colInd + _matSize.n_cols - 1 < _genRowVec.n_cols);
      throw e;
    }
  }
