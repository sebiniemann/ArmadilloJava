...
public class TestInPlaceGenMatRowIndRangeColIndRangeGenColVec extends TestClass {

  @Parameters(name = "{index}: GenMat = {0}, RowIndRange = {2}, ColIndRange = {4}, GenColVec = {6}")
  ...
  @Before
  public void before() {
    _fileSuffix = _genMatString + "," + _rowIndRangeString + "," + _colIndRangeString + "," + _genColVecString;
  ...
  public void testMatSubmatEqualA() throws IOException {
    ...
    if(!_colIndRange._isEntireRange) {
      assumeThat(_genColVec.n_cols, is(_colIndRange._last - _colIndRange._first + 1));
    } else {
      assumeThat(_genColVec.n_cols, is(_genMat.n_cols));
    }

    _genMat.submat(_rowIndRange, _colIndRange, Op.EQUAL, _genColVec);
  ...
  public void testMatSubmatEqualB() throws IOException {
    ...
    _genMat.submat(_rowIndRange._first, _colIndRange._first, _rowIndRange._last, _colIndRange._last, Op.EQUAL, _genColVec);
  ...
  public void testMatSubmatPlusA() throws IOException {
    ...
    _genMat.submat(_rowIndRange, _colIndRange, Op.PLUS, _genColVec);
  ...
  public void testMatSubmatPlusB() throws IOException {
    ...
    _genMat.submat(_rowIndRange._first, _colIndRange._first, _rowIndRange._last, _colIndRange._last, Op.PLUS, _genColVec);
  ...
  public void testMatSubmatMinusA() throws IOException {
    ...
    _genMat.submat(_rowIndRange, _colIndRange, Op.MINUS, _genColVec);
  ...
  public void testMatSubmatMinusB() throws IOException {
    ...
    _genMat.submat(_rowIndRange._first, _colIndRange._first, _rowIndRange._last, _colIndRange._last, Op.MINUS, _genColVec);
  ...
  public void testMatSubmatElemTimesA() throws IOException {
    ...
    _genMat.submat(_rowIndRange, _colIndRange, Op.ELEMTIMES, _genColVec);
  ...
  public void testMatSubmatElemTimesB() throws IOException {
    ...
    _genMat.submat(_rowIndRange._first, _colIndRange._first, _rowIndRange._last, _colIndRange._last, Op.ELEMTIMES, _genColVec);
  ...
  public void testMatSubmatElemDivideA() throws IOException {
    ...
    _genMat.submat(_rowIndRange, _colIndRange, Op.ELEMDIVIDE, _genColVec);
  ...
  public void testMatSubmatElemDivideB() throws IOException {
    ...
    _genMat.submat(_rowIndRange._first, _colIndRange._first, _rowIndRange._last, _colIndRange._last, Op.ELEMDIVIDE, _genColVec);
