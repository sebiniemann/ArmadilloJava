...
public class TestInPlaceGenMatRowIndsGenColVec extends TestClass {

  @Parameters(name = "{index}: GenMat = {0}, RowInds = {2}, GenColVec = {4}")
  ...
  @Before
  public void before() {
    _fileSuffix = _genMatString + "," + _rowIndsString + "," + _genColVecString;
  ...
  public void testMatRowsEqual() throws IOException {
    ...
    assumeThat(_genColVec.n_rows, is(_rowInds.n_elem));
    assumeThat(_genColVec.n_cols, is(_genMat.n_cols));

    _genMat.rows(_rowInds, Op.EQUAL, _genColVec);
  ...
  public void testMatRowsPlus() throws IOException {
    ...
    _genMat.rows(_rowInds, Op.PLUS, _genColVec);
  ...
  public void testMatRowsMinus() throws IOException {
    ...
    _genMat.rows(_rowInds, Op.MINUS, _genColVec);
  ...
  public void testMatRowsElemTimes() throws IOException {
    ...
    _genMat.rows(_rowInds, Op.ELEMTIMES, _genColVec);
  ...
  public void testMatRowsElemDivide() throws IOException {
    ...
    _genMat.rows(_rowInds, Op.ELEMDIVIDE, _genColVec);
  ...
  public void testMatEach_rowEqual() throws IOException {
    ...
    _genMat.each_row(_rowInds, Op.EQUAL, _genColVec);
  ...
  public void testMatEach_rowPlus() throws IOException {
    ...
    _genMat.each_row(_rowInds, Op.PLUS, _genColVec);
  ...
  public void testMatEach_rowMinus() throws IOException {
    ...
    _genMat.each_row(_rowInds, Op.MINUS, _genColVec);
  ...
  public void testMatEach_rowElemTimes() throws IOException {
    ...
    _genMat.each_row(_rowInds, Op.ELEMTIMES, _genColVec);
  ...
  public void testMatEach_rowElemDivide() throws IOException {
    ...
    _genMat.each_row(_rowInds, Op.ELEMDIVIDE, _genColVec);
