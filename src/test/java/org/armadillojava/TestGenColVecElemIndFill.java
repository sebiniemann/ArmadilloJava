...
public class TestGenColVecElemIndFill extends TestClass {
  ...
  @Test
  public void testColElemIndFill() throws IOException {
    if(_fill == Fill.EYE || _fill == Fill.RANDN) return;
    Col col = new Col(_elemInd,_fill);
    
    assertMatEquals(col, load("Col.elemIndFill"));
