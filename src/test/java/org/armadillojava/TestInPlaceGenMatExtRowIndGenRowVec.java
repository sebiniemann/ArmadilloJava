...
public class TestInPlaceGenMatExtRowIndGenRowVec extends TestClass {

  @Parameters(name = "{index}: GenMat = {0}, ExtRowInd = {2}, GenRowVec = {4}")
  ...
  @Before
  public void before() {
    _fileSuffix = _genMatString + "," + _extRowIndString + "," + _genRowVecString;
