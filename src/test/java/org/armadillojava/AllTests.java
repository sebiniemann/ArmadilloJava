...
@SuiteClasses({
  ...
  TestInPlaceGenMat.class,
  TestInPlaceGenMatGenMat.class,
  TestInvMat.class,
  ...
  TestOOMat.class,
  TestOORowVec.class,
  TestRandomGenColVec.class,
  TestRandomGenMat.class,
  TestRandomGenMatDim.class,
  TestRandomGenRowVec.class,
  TestRandomNumElems.class,
  TestRandomNumElemsDistrParam.class,
  TestRandomNumRowsNumCols.class,
  TestRandomNumRowsNumColsDistrParam.class,
  TestSquMat.class,
