...
public class TestInPlaceGenMatColInd extends TestClass {
  ...
  public void testMatShedCols() throws IOException {
    assumeThat(_genMat.in_range(Span.all(), new Span(_colInd)), is(true));

    _genMat.shed_col(_colInd);

    assertMatEquals(_genMat, load("Mat.shed_col"));
  }
