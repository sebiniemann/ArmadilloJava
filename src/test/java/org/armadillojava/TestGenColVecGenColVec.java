...
public class TestGenColVecGenColVec extends TestClass {
  ...
  public void testToeplitz() throws IOException {
    assertMatEquals(Arma.toeplitz(_genColVecA, _genColVecB), load("toeplitz"));
  }
  ...
  public void testConv() throws IOException {
    assertMatEquals(Arma.conv(_genColVecA, _genColVecB), load("conv"));
  }
  ...
  public void testCross() throws IOException {
    ...
    assertMatEquals(Arma.cross(_genColVecA, _genColVecB), load("cross"));
  }
  ...
  public void testJoin_rows() throws IOException {
    ...
    assertMatEquals(Arma.join_rows(_genColVecA, _genColVecB), load("join_rows"));
  }
  ...
  public void testJoin_horiz() throws IOException {
    ...
    assertMatEquals(Arma.join_horiz(_genColVecA, _genColVecB), load("join_horiz"));
  }
  ...
  public void testJoin_cols() throws IOException {
    ...
    assertMatEquals(Arma.join_cols(_genColVecA, _genColVecB), load("join_cols"));
  }
  ...
  public void testJoin_vert() throws IOException {
    ...
    assertMatEquals(Arma.join_vert(_genColVecA, _genColVecB), load("join_vert"));
  }

  @Test
  public void testKron() throws IOException {
    assertMatEquals(Arma.kron(_genColVecA, _genColVecB), load("kron"));
  }
