...
public class TestInPlaceGenColVecElemIndsGenMat extends TestClass {

  @Parameters(name = "{index}: GenColVec = {0}, ElemInds = {2}, GenMat = {4}")
  ...
  @Before
  public void before() {
    _fileSuffix = _genColVecString + "," + _elemIndsString + "," + _genMatString;
  ...
  public void testColElemEqual() throws IOException {
    ...
    _genColVec.elem(_elemInds, Op.EQUAL, _genMat);
  ...
  public void testColElemPlus() throws IOException {
    ...
    _genColVec.elem(_elemInds, Op.PLUS, _genMat);
  ...
  public void testColElemMinus() throws IOException {
    ...
    _genColVec.elem(_elemInds, Op.MINUS, _genMat);
  ...
  public void testColElemElemTimes() throws IOException {
    ...
    _genColVec.elem(_elemInds, Op.ELEMTIMES, _genMat);
  ...
  public void testColElemElemDivide() throws IOException {
    ...
    _genColVec.elem(_elemInds, Op.ELEMDIVIDE, _genMat);
  ...
  public void testColRowsEqual() throws IOException {
    ...
    _genColVec.rows(_elemInds, Op.EQUAL, _genMat);
  ...
  public void testColRowsPlus() throws IOException {
    ...
    _genColVec.rows(_elemInds, Op.PLUS, _genMat);
  ...
  public void testColRowsMinus() throws IOException {
    ...
    _genColVec.rows(_elemInds, Op.MINUS, _genMat);
  ...
  public void testColRowsElemTimes() throws IOException {
    ...
    _genColVec.rows(_elemInds, Op.ELEMTIMES, _genMat);
  ...
  public void testColRowsElemDivide() throws IOException {
    ...
    _genColVec.rows(_elemInds, Op.ELEMDIVIDE, _genMat);
