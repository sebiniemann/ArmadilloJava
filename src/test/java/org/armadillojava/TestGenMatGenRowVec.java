...
public class TestGenMatGenRowVec extends TestClass {
  ...
  public void testCross() throws IOException {
    ...
    assertMatEquals(Arma.cross(_genMat, _genRowVec), load("cross"));
  }
  ...
  public void testJoin_rows() throws IOException {
    ...
    assertMatEquals(Arma.join_rows(_genMat, _genRowVec), load("join_rows"));
  }
  ...
  public void testJoin_horiz() throws IOException {
    ...
    assertMatEquals(Arma.join_horiz(_genMat, _genRowVec), load("join_horiz"));
  }
  ...
  public void testJoin_cols() throws IOException {
    ...
    assertMatEquals(Arma.join_cols(_genMat, _genRowVec), load("join_cols"));
  }
  ...
  public void testJoin_vert() throws IOException {
    ...
    assertMatEquals(Arma.join_vert(_genMat, _genRowVec), load("join_vert"));
  }

  @Test
  public void testKron() throws IOException {
    assertMatEquals(Arma.kron(_genMat, _genRowVec), load("kron"));
  }
