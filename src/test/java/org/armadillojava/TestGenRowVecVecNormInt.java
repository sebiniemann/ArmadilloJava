...
public class TestGenRowVecVecNormInt extends TestClass {

  @Parameters(name = "{index}: GenRowVec = {0}, VecNormInt = {2}")
  ...
  @Before
  public void before() {
    _fileSuffix = _genRowVecString + "," + _vecNormIntString;
  ...
  public void testArmaNorm() throws IOException {
    ...
    double actual = Arma.norm(_genRowVec, _vecNormInt);
