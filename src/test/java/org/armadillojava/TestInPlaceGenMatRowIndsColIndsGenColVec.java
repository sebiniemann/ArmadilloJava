...
public class TestInPlaceGenMatRowIndsColIndsGenColVec extends TestClass {

  @Parameters(name = "{index}: GenMat = {0}, RowInds = {2}, ColInds = {4}, GenColVec = {6}")
  ...
  @Before
  public void before() {
    _fileSuffix = _genMatString + "," + _rowIndsString + "," + _colIndsString + "," + _genColVecString;
  ...
  public void testMatSubmatEqual() throws IOException {
    ...
    assumeThat(_genColVec.n_cols, is(_colInds.n_elem));

    _genMat.submat(_rowInds, _colInds, Op.EQUAL, _genColVec);
  ...
  public void testMatSubmatPlus() throws IOException {
    ...
    _genMat.submat(_rowInds, _colInds, Op.PLUS, _genColVec);
  ...
  public void testMatSubmatMinus() throws IOException {
    ...
    _genMat.submat(_rowInds, _colInds, Op.MINUS, _genColVec);
  ...
  public void testMatSubmatElemTimes() throws IOException {
    ...
    _genMat.submat(_rowInds, _colInds, Op.ELEMTIMES, _genColVec);
  ...
  public void testMatSubmatElemDivide() throws IOException {
    ...
    _genMat.submat(_rowInds, _colInds, Op.ELEMDIVIDE, _genColVec);
