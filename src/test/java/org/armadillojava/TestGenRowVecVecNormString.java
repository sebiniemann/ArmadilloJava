...
public class TestGenRowVecVecNormString extends TestClass {

  @Parameters(name = "{index}: GenRowVec = {0}, VecNormString = {2}")
  ...
  @Before
  public void before() {
    _fileSuffix = _genRowVecString + "," + _vecNormStringString;
  ...
  public void testArmaNorm() throws IOException {
    ...
    double actual = Arma.norm(_genRowVec, _vecNormString);
