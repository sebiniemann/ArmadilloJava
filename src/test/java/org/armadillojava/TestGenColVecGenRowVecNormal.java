...
public class TestGenColVecGenRowVecNormal extends TestClass {

  @Parameters(name = "{index}: GenColVec = {0}, GenRowVec = {2}, Normal = {4}")
  ...
  @Before
  public void before() {
    _fileSuffix = _genColVecString + "," + _genRowVecString + "," + _normalString;
  ...
  public void testArmaCor() throws IOException {
    ...
    double actual = Arma.cor(_genColVec, _genRowVec, _normal);
  ...
  public void testArmaCov() throws IOException {
    ...
    double actual = Arma.cov(_genColVec, _genRowVec, _normal);
