  ...
  class ExpectedGenColVecVecNormInt : public Expected {
    public:
      ExpectedGenColVecVecNormInt() {
        ...
        vector<vector<pair<string, void*>>> inputs = Input::getTestParameters({InputClass::GenColVec, InputClass::VecNormInt});
    ...
    protected:
      ...
      void expectedNorm() {
        ...
        save("norm", Mat<double>({norm(_genColVec, _vecNormInt)}));
        cout << "done." << endl;
      }
