  ...
  class ExpectedGenMatGenMatNormal : public Expected {
    public:
      ExpectedGenMatGenMatNormal() {
        ...
        vector<vector<pair<string, void*>>> inputs = Input::getTestParameters({InputClass::GenMat, InputClass::GenMat, InputClass::Normal});
    ...
    protected:
      ...
      void expectedCor() {
        ...
        save("cor", cor(_genMatA, _genMatB, _normal));
        cout << "done." << endl;
      }
      ...
      void expectedCov() {
        ...
        save("cov", cov(_genMatA, _genMatB, _normal));
        cout << "done." << endl;
      }
  };
}
