...
namespace armadilloJava {
  class ExpectedInPlaceGenMatColIndRangeGenRowVec : public Expected {
    public:
      ExpectedInPlaceGenMatColIndRangeGenRowVec() {
        cout << "Compute ExpectedInPlaceGenMatColIndRangeGenRowVec(): " << endl;
    ...
    protected:
      ...
      void expectedMatColsEqual() {
        ...
        _genMat.cols(_colIndRange.a, _colIndRange.b) = _genRowVec;
