  ...
  class ExpectedGenMatGenColVec : public Expected {
    public:
      ExpectedGenMatGenColVec() {
        ...
        vector<vector<pair<string, void*>>> inputs = Input::getTestParameters({InputClass::GenMat, InputClass::GenColVec});
    ...
    protected:
      ...
      void expectedCross() {
        ...
        save("cross", cross(_genMat, _genColVec));
        cout << "done." << endl;
      }
      ...
      void expectedJoin_rows() {
        ...
        save("join_rows", join_rows(_genMat, _genColVec));
        cout << "done." << endl;
      }
      ...
      void expectedJoin_horiz() {
        ...
        save("join_horiz", join_horiz(_genMat, _genColVec));
        cout << "done." << endl;
      }
      ...
      void expectedJoin_cols() {
        ...
        save("join_cols", join_cols(_genMat, _genColVec));
        cout << "done." << endl;
      }
      ...
      void expectedJoin_vert() {
        ...
        save("join_vert", join_cols(_genMat, _genColVec));
        cout << "done." << endl;
      }

      void expectedKron() {
        cout << "- Compute expectedKron() ... ";
        save("kron", kron(_genMat, _genColVec));
        cout << "done." << endl;
      }
