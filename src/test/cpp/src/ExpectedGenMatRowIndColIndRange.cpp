...
namespace armadilloJava {
  class ExpectedGenMatRowIndColIndRange : public Expected {
    public:
      ExpectedGenMatRowIndColIndRange() {
        cout << "Compute ExpectedGenMatRowIndColIndRange(): " << endl;
    ...
    protected:
      ...
      void expectedMatRow() {
        ...
        save<double>("Mat.row", _genMat(_rowInd, _colIndRange));
        cout << "done." << endl;
      }
  };
}
