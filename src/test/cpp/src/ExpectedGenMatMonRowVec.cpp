  ...
  class ExpectedGenMatMonRowVec : public Expected {
    public:
      ExpectedGenMatMonRowVec() {
        ...
        vector<vector<pair<string, void*>>> inputs = Input::getTestParameters({InputClass::GenMat, InputClass::MonRowVec});
    ...
    protected:
      ...
      void expectedHist() {
        ...
        Mat<uword> expected = hist(_genMat, _monRowVec);
      ...
      void expectedHistc() {
        ...
        Mat<uword> expected = histc(_genMat, _monRowVec);
