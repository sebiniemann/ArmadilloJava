...
namespace armadilloJava {
  class ExpectedGenDoubleGenDoubleNumElems : public Expected {
    public:
      ExpectedGenDoubleGenDoubleNumElems() {
        cout << "Compute ExpectedGenDoubleGenDoubleNumElems(): " << endl;

        vector<vector<pair<string, void*>>> inputs = Input::getTestParameters({InputClass::GenDouble, InputClass::GenDouble, InputClass::NumElems});
