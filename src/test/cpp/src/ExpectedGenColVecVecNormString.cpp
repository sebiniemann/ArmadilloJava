  ...
  class ExpectedGenColVecVecNormString : public Expected {
    public:
      ExpectedGenColVecVecNormString() {
        ...
        vector<vector<pair<string, void*>>> inputs = Input::getTestParameters({InputClass::GenColVec, InputClass::VecNormString});
    ...
    protected:
      ...
      void expectedNorm() {
        ...
        save("norm", Mat<double>({norm(_genColVec, _vecNormString.c_str())}));
        cout << "done." << endl;
      }
